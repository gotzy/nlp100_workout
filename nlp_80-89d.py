...
y_train = [ 0 if y=='b' else 1 if y=='t' else 2 if y=='e' else 3 for y in train[0]]
y_valid = [ 0 if y=='b' else 1 if y=='t' else 2 if y=='e' else 3 for y in valid[0]]
y_test = [ 0 if y=='b' else 1 if y=='t' else 2 if y=='e' else 3 for y in test[0]]
...
import gensim
w2v =  gensim.models.KeyedVectors.load_word2vec_format('07_dir/GoogleNews-vectors-negative300.bin', binary=True)
