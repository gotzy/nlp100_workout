...
'''
http://www.phontron.com/kftt/index-ja.html#data
データのみ
京都フリー翻訳タスクで研究を行う際はなるべくベースラインシステムを構築することをおすすめしますが、
データのみを以下のリンクからダウンロードすることもできます：
...
train_ja = '10_dir/kftt-data-1.0/data/tok/kyoto-train.cln.ja'
train_en = '10_dir/kftt-data-1.0/data/tok/kyoto-train.cln.en'
...
test_ja = '10_dir/kftt-data-1.0/data/tok/kyoto-test.ja'
test_en = '10_dir/kftt-data-1.0/data/tok/kyoto-test.en'
