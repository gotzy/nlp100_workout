...
train_x, train_t = read_feature_dataset('06_dir/train.txt')
valid_x, valid_t = read_feature_dataset('06_dir/valid.txt')
test_x, test_t = read_feature_dataset('06_dir/test.txt')
...
model(next(iter(loader))).argmax(dim=-1)
